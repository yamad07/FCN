...
parser.add_argument('--labelfile', required=True,help='gpu or cpu')
...
datasets = ListDataset(args.dataroot, batch_size, args.labelfile, args.labelroot,  train=True, transform=transform)
